...
?>
	...
	<?if ($arItem["IS_PARENT"]):?>
		...
		<?else:?>
			...
			<li<?if ($arItem["SELECTED"]):?> class="item-selected"<?endif?>><a href="<?=$arItem["LINK"]?>" class="<?=$classStyle?>  parent"><?=$arItem["TEXT"]?></a>
	...
	<?else:?>
		...
		<?if ($arItem["PERMISSION"] > "D"):?>
			...
			<?else:?>
				<li<?if ($arItem["SELECTED"]):?> class="item-selected"<?endif?>><a class ="<?=$classStyle?>" href="<?=$arItem["LINK"]?>"><?=$arItem["TEXT"]?></a></li>
			<?endif?>
