...
<div class="news-detail">
	 <hr>
						...
						<p><?=GetMessage("DOCUMENTS")?></p>
							...
							<div  class="exam-review-item-doc"><img class="rew-doc-ico" src="/local/templates/.default/img/icons/pdf_ico_40.png"><a href="<?=$arResult["DISPLAY_PROPERTIES"]["ADDITIONAL_DOCS"]["FILE_VALUE"]["SRC"]?>"><?=$arResult["DISPLAY_PROPERTIES"]["ADDITIONAL_DOCS"]["FILE_VALUE"]["ORIGINAL_NAME"]?></a></div>
						...
						<div  class="exam-review-item-doc"><img class="rew-doc-ico" src="/local/templates/.default/img/icons/pdf_ico_40.png"><a href="<?=$arItem["SRC"]?>"><?=$arItem["ORIGINAL_NAME"]?></a></div>
